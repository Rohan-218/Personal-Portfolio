...
const techStackSections = [
  {
    ...
    rows: [
      [
        ...
        { name: "SQL", icon: <TbSql className="h-10 w-10 text-[#f89820]" /> },
  ...
  },
  {
    ...
    rows: [
      [
        ...
        { name: "Express.js", icon: <SiExpress className="h-10 w-10 text-[#444444]" /> },
  ...
  {
    label: "Databases",
    icon: <DiDatabase className="w-7 h-7 text-[#a78bfa] bg-[#272133] rounded-xl p-1" />,
    description: "Database management systems",
    rows: [
      [
        { name: "MongoDB", icon: <SiMongodb className="h-10 w-10 text-[#4db33d]" /> },
        { name: "PostgreSQL", icon: <SiPostgresql className="h-10 w-10 text-[#00758f]" /> },
      ],
    ],
  },
  {
    ...
    rows: [
      [
        ...
        { name: "GitHub", icon: <FaGithub className="h-10 w-10 text-[#444444]" /> },
        { name: "Postman", icon: <SiPostman className="h-10 w-10 text-[#FF6C37]" /> },
        { name: "Figma", icon: <SiFigma className="h-10 w-10 text-[#333333]" /> },
