...
const experience = [
  {
    ...
    org: "MEMORRES DIGITAL PRIVATE LIMITED",
    description: "Built a full-stack Student Teacher Portal using React, Node.js, Express, and PostgreSQL. Implemented authentication and CRUD features.",
...
const education = [
  {
    ...
    description: "Coursework in algorithms, data structures, and full-stack development. Participated in software development clubs.",
    year: "2021 – 2025",
  },
  {
    title: "HSC (12th Grade)",
    org: "POLKAJI SHIKSHAN SANSTHAN PIPRALI ROAD SIKAR RJ, CBSE",
    description: "Achieved 75%. Excelled in Mathematics and Physics, active in science exhibitions.",
    year: "2021",
  },
  {
    title: "SSLC (10th Grade)",
    org: "Mount Carmel Convent School, CBSE",
