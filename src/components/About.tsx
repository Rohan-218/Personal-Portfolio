...
const timeline = [
  ...
  },
  {
    ...
    content: "Full Stack Development (MERN & PERN)",
    year: "2022 - Present",
            ...
            >
              <Card className="p-8 bg-card/50 backdrop-blur-sm border-border/50 hover:border-accent/50 transition-all duration-300 hover:shadow-lg hover:shadow-accent/5">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Full Stack Developer and B.Tech CSE student with a passion for building scalable web apps. Experienced in React, Node.js, Postgres, MongoDB, and more, with a solid grasp of system design and clean coding practices.
                </p>
                <motion.button
